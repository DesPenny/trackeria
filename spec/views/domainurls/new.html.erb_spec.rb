...
describe "domainurls/new" do
  before(:each) do
    assign(:domainurl, stub_model(Domainurl,
      :user_id => 1,
      :domainurl => "MyString",
      :keyword => "MyString",
      :category => "MyString",
  ...
  it "renders new domainurl form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", domainurls_path, "post" do
